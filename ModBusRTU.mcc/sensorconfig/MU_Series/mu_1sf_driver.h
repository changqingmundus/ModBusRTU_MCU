 ...
 * @note Designed according to iC-MU series datasheet release B1 for iC-MU128, iC-MU150 and iC-MU200 chip revision X1.
 ******************************************************************************
 * @attention
 *
...
typedef enum {
	...
	CMD_MU_MODEA_SPI = 0x12,		// exclusively supported by iC-MU128, iC-MU150 and iC-MU200
	CMD_MU_ROT_POS = 0x13,			// exclusively supported by iC-MU128, iC-MU150 and iC-MU200
	CMD_MU_ROT_POS_E2P = 0x14,		// exclusively supported by iC-MU128, iC-MU150 and iC-MU200
} CMD_MU;
/**
 * @}
 */
...
/**
 * @addtogroup MU_Parameters_MU128_MU150_MU200_Exclusive
 * @brief Parameters exclusively available in iC-MU128, iC-MU150 and iC-MU200.
 * @{
 */
