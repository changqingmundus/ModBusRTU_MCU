...
function(ModBusRTU_MCU_default_objcopy_lss_rule target)
    add_custom_command(
        TARGET ${target}
        POST_BUILD
        COMMAND ${OBJDUMP}
        ARGS --disassemble --wide --demangle --line-numbers --section-headers --source ${ModBusRTU_MCU_default_image_name} > ${ModBusRTU_MCU_default_image_base_name}.lss
        WORKING_DIRECTORY ${ModBusRTU_MCU_default_output_dir})
endfunction()
